...
- [x] 3.8 Kliknąć filtry — karty aktualizują się poprawnie ✓
- [x] 3.9 Wpisać tekst w wyszukiwarce — karty filtrują się w czasie rzeczywistym ✓
- [x] 3.10 Kliknąć kartę — modal otwiera się ze szczegółami ✓
- [x] 3.11 Sprawdzić konsolę — brak błędów ✓

---

## Sekcja 4: Udoskonalenia designu i funkcjonalności

- [x] 4.1 Dodać efekt parallax w sekcji hero (tło przesuwa się wolniej przy scrollu) ✓
- [x] 4.2 Zaimplementować smooth scroll do sekcji po kliknięciu w nawigację ✓
- [x] 4.3 Dodać licznik wyświetlonych roślin ("Wyświetlane: X z Y") ✓
- [x] 4.4 Dodać przycisk "Wróć na górę" (scroll to top) ✓
- [x] 4.5 Zoptymalizować obrazki (lazy loading z `loading="lazy"`) ✓

### Weryfikacja Sekcji 4
- [x] 4.6 Przeskrollować stronę — efekt parallax widoczny ✓
- [x] 4.7 Kliknąć przycisk "Wróć na górę" — strona przewija się do góry ✓
- [x] 4.8 Sprawdzić czy lazy loading działa (network w DevTools) ✓
